...
# Docker image for python using the alpine template
ARG IMAGE_NAME="python"
ARG PHP_SERVER="python"
ARG BUILD_DATE="202408131929"
...
ENV HOSTNAME="casjaysdevdocker-python"
...
LABEL org.opencontainers.image.url="https://hub.docker.com/r/casjaysdevdocker/python"
LABEL org.opencontainers.image.url.source="https://hub.docker.com/r/casjaysdevdocker/python"
LABEL org.opencontainers.image.vcs-type="Git"
LABEL org.opencontainers.image.vcs-ref="${BUILD_VERSION}"
LABEL org.opencontainers.image.vcs-url="https://github.com/casjaysdevdocker/python"
LABEL org.opencontainers.image.documentation="https://github.com/casjaysdevdocker/python"
